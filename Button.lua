local function Probe(region)
    return region:GetObjectType() == "Button" and (region:GetName() ~= nil or Vimp_Validate(region:GetRegions()) or Vimp_Validate(region:GetChildren()))
end
